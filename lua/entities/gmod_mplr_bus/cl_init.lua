...
function ENT:Initialize()
    ...
    self:EmitAmbientSound("lilly/ambience/vehicles/citaro.wav", 75, 100, 100)
    self.SoundTime = RealTime()
    --self:StartLoopingSound("lilly/ambience/vehicles/citaro.wav")
end

function ENT:Think()
    if RealTime() - self.SoundTime > 55 then self:EmitAmbientSound("lilly/ambience/vehicles/citaro.wav", 75, 100, 100) end
end
